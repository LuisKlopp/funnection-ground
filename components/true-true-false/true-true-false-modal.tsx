...
export const TrueTrueFalseModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="box-shadow-04 relative mx-4 flex h-[600px] w-[500px] flex-col items-center justify-evenly rounded-lg bg-[#d6ecf8] shadow-lg">
        <button
        ...
        <button
          ...
          className="rounded-lg bg-gray-700 px-6 py-4 text-[20px] text-white shadow-md hover:bg-gray-800"
        >
          확인
        </button>
      </div>
